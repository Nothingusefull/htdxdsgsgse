_G.Tools = true
task.spawn(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Nitro-GT/Oxide/main/vroxperma"))()
end)
...
local ViewportRange = 10 -- Maximum distance players are updated
...
character.ChildAdded:Connect(function(v)
	...
	local vel = game:GetService("RunService").Heartbeat:Connect(function()
		fake.AssemblyLinearVelocity = Vector3.new(0,0,0)
		fake.AssemblyAngularVelocity = Vector3.new(0,0,0)
	end)
